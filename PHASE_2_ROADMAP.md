...
- [ ] **e2e cleanup path (convenience, not load-bearing):** deactivation gives the test suite a tidy way to retire accounts *within the test project*. It is **no longer** the answer to test-data residue — that's the separate test project (Workstream 0) — but it's still handy.
